...
<body class="bg-gray-100 p-8">
    <div class="max-w-6xl mx-auto">
        ...
        <form method="GET" class="mb-6 flex items-center gap-4">
            ...
            <select name="semana" id="semana" class="border p-2 rounded-md" required>
            ...
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition">Filtrar</button>
        </form>
