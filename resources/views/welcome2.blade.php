<x-app-layout>
    <x-slot name="header">
        <h2 class="bg-white dark:bg-gray-800 leading-tight text-center">
    ...
    <body class="bg-gray-100 p-8 flex flex-col items-center relative min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10 mt-12">
            ...
            <!-- Tarjeta para 5S -->
            <a href="{{ route('welcome') }}" class="bg-white dark:bg-gray-800  p-6 rounded-lg shadow-lg flex flex-col items-center justify-center transition transform hover:scale-105 hover:shadow-xl text-center">
                <img src="storage/images/5s.png" class="w-16 h-16 mb-4" alt="5S">
                <span class="text-lg font-semibold text-green-500">Módulo 5S</span>
            </a>

            <!-- Tarjeta para Agua -->
            <a href="{{ route('agua.index') }}" class="bg-white dark:bg-gray-800  p-6 rounded-lg shadow-lg flex flex-col items-center justify-center transition transform hover:scale-105 hover:shadow-xl text-center">
            ...
            <!-- Tarjeta para Luz -->
            <a href="{{ route('luz.index') }}" class="bg-white dark:bg-gray-800  p-6 rounded-lg shadow-lg flex flex-col items-center justify-center transition transform hover:scale-105 hover:shadow-xl text-center">
            ...
            <a href="#" class="bg-white dark:bg-gray-800  p-6 rounded-lg shadow-lg flex flex-col items-center justify-center transition transform hover:scale-105 hover:shadow-xl text-center">
